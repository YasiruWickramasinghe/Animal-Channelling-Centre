<template>
  <div>
    <div class="container-fluid cat-management-update-container">
      <h2 class="heading text-start mt-5 p-5 pb-0">Cat Management - Update</h2>
      <div class="row p-5">
        <div class="col">
        ...
        <div class="col">
          <div class="w-75 text-start fw-bolder">
            <form @submit.prevent="updateCat" method="put">
              <div class="mb-3">
...
export default {
  ...
  methods: {
    getCat() {
      ...
      Vue.axios.get("http://localhost:5000/api/cat/" + id).then((res) => {
        this.cat = res.data.results;
      });
    },
    updateCat() {
      const id = this.$route.params.id;
      Vue.axios
        .put("http://localhost:5000/api/cat/" + id, this.cat)
        .then(() => {
...
.cat-management-update-container {
  width: 90%;
  top: 155px;
  background: #ffffff;
